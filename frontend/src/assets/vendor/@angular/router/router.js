/* esm-bundle - @angular/router - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', 'rxjs', '@angular/common', 'rxjs/operators', '@angular/platform-browser'], (function (exports) {
    'use strict';
    var i0, Injectable, _RuntimeError, EventEmitter, inject, ViewContainerRef, ChangeDetectorRef, EnvironmentInjector, Directive, Input, Output, InjectionToken, reflectComponentType, Component, Compiler, NgModuleFactory, _Console, _InitialRenderPendingTasks, NgZone, __sanitizeUrlOrResourceUrl, booleanAttribute, Attribute, HostBinding, HostListener, Optional, ContentChildren, createEnvironmentInjector, SkipSelf, NgProbeToken, NgModule, Inject, APP_BOOTSTRAP_LISTENER, Version, _isPromise, _isNgModule, isStandalone, makeEnvironmentProviders, Injector, ApplicationRef, InjectFlags, _isInjectable, ENVIRONMENT_INITIALIZER, APP_INITIALIZER, combineLatest, of, ConnectableObservable, Subject, from, BehaviorSubject, EMPTY, Subscription, isObservable, concat, defer, throwError, EmptyError, pipe, Location, i3, ViewportScroller, LocationStrategy, HashLocationStrategy, PathLocationStrategy, LOCATION_INITIALIZED, switchMap, map, tap, finalize, refCount, mergeMap, filter, take, takeUntil, catchError, mergeAll, concatMap, first, defaultIfEmpty, startWith, scan, last$1, takeLast, mapTo, i1;
    return {
        setters: [function (module) {
            ...
            _InitialRenderPendingTasks = module.ɵInitialRenderPendingTasks;
    ...
    `);
            ...
            class ApplyRedirects {
              ...
              noMatchError(e) {
                return new _RuntimeError(4002 /* RuntimeErrorCode.NO_MATCH */, (typeof ngDevMode === 'undefined' || ngDevMode) && `Cannot match any routes. URL Segment: '${e.segmentGroup}'`);
              }
             ...
             * @publicApi
             */
            const ROUTES = exports("ROUTES", new InjectionToken('ROUTES'));
            ...
            class Router {
              ...
              constructor() {
                ...
                this.pendingTasks = inject(_InitialRenderPendingTasks);
                /**
