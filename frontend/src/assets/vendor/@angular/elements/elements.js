/* esm-bundle - @angular/elements - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', 'rxjs', 'rxjs/operators'], (function (exports) {
    'use strict';
    var Version, ComponentFactoryResolver, NgZone, Injector, ChangeDetectorRef, ApplicationRef, SimpleChange, ReplaySubject, merge, switchMap, map;
    return {
