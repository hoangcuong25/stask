/* esm-bundle - @angular/cdk/tree - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/cdk/collections', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/cdk/coercion', '@angular/cdk/bidi'], (function (exports) {
    'use strict';
    var isDataSource, SelectionModel, Subject, BehaviorSubject, isObservable, of, takeUntil, take, filter, InjectionToken, i0, Directive, Inject, Optional, Component, ViewEncapsulation, ChangeDetectionStrategy, Input, ViewChild, ContentChildren, NgModule, coerceNumberProperty, coerceBooleanProperty, i2;
    return {
        ...
        execute: (function () {
            ...
            exports({
                getTreeControlFunctionsMissingError: getTreeControlFunctionsMissingError,
                getTreeControlMissingError: getTreeControlMissingError,
                getTreeMissingMatchingNodeDefError: getTreeMissingMatchingNodeDefError,
                getTreeMultipleDefaultNodeDefsError: getTreeMultipleDefaultNodeDefsError,
                getTreeNoValidDataSourceError: getTreeNoValidDataSourceError
            });
             ...
             * @docs-private
             */
            const CDK_TREE_NODE_OUTLET_NODE = exports("CDK_TREE_NODE_OUTLET_NODE", new InjectionToken('CDK_TREE_NODE_OUTLET_NODE'));
            /**
