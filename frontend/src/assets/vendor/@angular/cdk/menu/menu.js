/* esm-bundle - @angular/cdk/menu - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', '@angular/cdk/overlay', '@angular/cdk/keycodes', 'rxjs/operators', '@angular/cdk/collections', 'rxjs', '@angular/cdk/portal', '@angular/cdk/a11y', '@angular/cdk/coercion', '@angular/cdk/bidi', '@angular/cdk/platform'], (function (exports) {
    'use strict';
    var i0, Directive, InjectionToken, Optional, SkipSelf, Inject, Injectable, inject, Injector, ViewContainerRef, EventEmitter, NgZone, ElementRef, ChangeDetectorRef, Input, Output, ContentChildren, NgModule, Overlay, OverlayConfig, STANDARD_DROPDOWN_BELOW_POSITIONS, STANDARD_DROPDOWN_ADJACENT_POSITIONS, OverlayModule, UP_ARROW, hasModifierKey, DOWN_ARROW, LEFT_ARROW, RIGHT_ARROW, ENTER, SPACE, TAB, ESCAPE, startWith, debounceTime, distinctUntilChanged, filter, takeUntil, mergeMap, mapTo, mergeAll, switchMap, skipWhile, skip, UniqueSelectionDispatcher, Subject, merge, fromEvent, partition, defer, TemplatePortal, InputModalityDetector, FocusKeyManager, coerceBooleanProperty, Directionality, _getEventTarget;
    return {
        setters: [function (module) {
            ...
            OverlayConfig = module.OverlayConfig;
            STANDARD_DROPDOWN_BELOW_POSITIONS = module.STANDARD_DROPDOWN_BELOW_POSITIONS;
            STANDARD_DROPDOWN_ADJACENT_POSITIONS = module.STANDARD_DROPDOWN_ADJACENT_POSITIONS;
            ...
            skipWhile = module.skipWhile;
            skip = module.skip;
        }, function (module) {
            UniqueSelectionDispatcher = module.UniqueSelectionDispatcher;
        }, function (module) {
            ...
            TemplatePortal = module.TemplatePortal;
        }, function (module) {
            InputModalityDetector = module.InputModalityDetector;
        ...
        execute: (function () {
            ...
            const CDK_MENU = exports("CDK_MENU", new InjectionToken('cdk-menu'));

            /** Injection token used for an implementation of MenuStack. */
            const MENU_STACK = exports("MENU_STACK", new InjectionToken('cdk-menu-stack'));
            /** Provider that provides the parent menu stack, or a new menu stack if there is no parent one. */
            const PARENT_OR_NEW_MENU_STACK_PROVIDER = exports("PARENT_OR_NEW_MENU_STACK_PROVIDER", {
              provide: MENU_STACK,
              deps: [[new Optional(), new SkipSelf(), new Inject(MENU_STACK)]],
              useFactory: parentMenuStack => parentMenuStack || new MenuStack()
            });
            /** Provider that provides the parent menu stack, or a new inline menu stack if there is no parent one. */
            const PARENT_OR_NEW_INLINE_MENU_STACK_PROVIDER = exports("PARENT_OR_NEW_INLINE_MENU_STACK_PROVIDER", orientation => ({
              provide: MENU_STACK,
              deps: [[new Optional(), new SkipSelf(), new Inject(MENU_STACK)]],
            ...
            /** Injection token used for an implementation of MenuStack. */
            const MENU_TRIGGER = exports("MENU_TRIGGER", new InjectionToken('cdk-menu-trigger'));
            /**
            ...
            } exports("CdkMenuTriggerBase", CdkMenuTriggerBase);
            (function () {
            ...
            const MENU_AIM = exports("MENU_AIM", new InjectionToken('cdk-menu-aim'));
            ...
            } exports("CdkMenuTrigger", CdkMenuTrigger);
            (function () {
            ...
            } exports("PointerFocusTracker", PointerFocusTracker);
            ...
            } exports("CdkMenuBase", CdkMenuBase);
            (function () {
            ...
            } exports("CdkMenuItemSelectable", CdkMenuItemSelectable);
            (function () {
