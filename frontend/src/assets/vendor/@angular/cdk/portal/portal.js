/* esm-bundle - @angular/cdk/portal - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', '@angular/common'], (function (exports) {
    'use strict';
    var i0, Directive, EventEmitter, Inject, Output, NgModule, ElementRef, Injector, DOCUMENT;
    return {
        ...
        execute: (function () {
             ...
             */
            class BasePortalHost extends BasePortalOutlet {} exports("BasePortalHost", BasePortalHost);
             ...
             * @breaking-change 9.0.0
             */
            class DomPortalHost extends DomPortalOutlet {} exports("DomPortalHost", DomPortalHost);
