/* esm-bundle - @angular/cdk/accordion - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', '@angular/cdk/collections', '@angular/cdk/coercion', 'rxjs'], (function (exports) {
    'use strict';
    var InjectionToken, i0, Directive, Input, EventEmitter, Optional, Inject, SkipSelf, Output, NgModule, i1, coerceBooleanProperty, Subject, Subscription;
    return {
        ...
        execute: (function () {
             ...
             */
            const CDK_ACCORDION = exports("CDK_ACCORDION", new InjectionToken('CdkAccordion'));
            /**
