/* esm-bundle - @angular/cdk/scrolling - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/cdk/coercion', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/cdk/platform', '@angular/common', '@angular/cdk/bidi', '@angular/cdk/collections'], (function (exports) {
    'use strict';
    var coerceNumberProperty, coerceElement, coerceBooleanProperty, InjectionToken, i0, forwardRef, Directive, Input, Injectable, Optional, Inject, inject, Component, ViewEncapsulation, ChangeDetectionStrategy, Output, ViewChild, SkipSelf, ElementRef, NgModule, Subject, of, Observable, fromEvent, Subscription, isObservable, animationFrameScheduler, asapScheduler, auditTime, filter, takeUntil, startWith, pairwise, switchMap, shareReplay, distinctUntilChanged, i1, getRtlScrollAxisType, supportsScrollBehavior, Platform, DOCUMENT, i2, BidiModule, isDataSource, ArrayDataSource, _VIEW_REPEATER_STRATEGY, _RecycleViewRepeaterStrategy, i2$1;
    return {
        setters: [function (module) {
            ...
            pairwise = module.pairwise;
            switchMap = module.switchMap;
            shareReplay = module.shareReplay;
            distinctUntilChanged = module.distinctUntilChanged;
        }, function (module) {
            i1 = module;
            getRtlScrollAxisType = module.getRtlScrollAxisType;
            supportsScrollBehavior = module.supportsScrollBehavior;
            ...
            isDataSource = module.isDataSource;
            ArrayDataSource = module.ArrayDataSource;
            _VIEW_REPEATER_STRATEGY = module._VIEW_REPEATER_STRATEGY;
            _RecycleViewRepeaterStrategy = module._RecycleViewRepeaterStrategy;
            i2$1 = module;
        }],
        execute: (function () {
            ...
            const _c1 = ["*"];
            const VIRTUAL_SCROLL_STRATEGY = exports("VIRTUAL_SCROLL_STRATEGY", new InjectionToken('VIRTUAL_SCROLL_STRATEGY'));
            ...
            const DEFAULT_SCROLL_TIME = exports("DEFAULT_SCROLL_TIME", 20);
            /**
            ...
            const DEFAULT_RESIZE_TIME = exports("DEFAULT_RESIZE_TIME", 20);
            /**
            ...
            const VIRTUAL_SCROLLABLE = exports("VIRTUAL_SCROLLABLE", new InjectionToken('VIRTUAL_SCROLLABLE'));
            /**
            ...
            } exports("CdkVirtualScrollable", CdkVirtualScrollable);
            (function () {
            ...
            } exports("CdkVirtualScrollableElement", CdkVirtualScrollableElement);
            (function () {
            ...
            } exports("CdkVirtualScrollableWindow", CdkVirtualScrollableWindow);
            (function () {
