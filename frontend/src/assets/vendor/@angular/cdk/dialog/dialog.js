/* esm-bundle - @angular/cdk/dialog - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/cdk/a11y', '@angular/cdk/overlay', '@angular/cdk/platform', '@angular/cdk/portal', '@angular/common', '@angular/core', '@angular/cdk/keycodes', 'rxjs', '@angular/cdk/bidi', 'rxjs/operators'], (function (exports) {
    'use strict';
    var i1, A11yModule, i1$1, OverlayConfig, OverlayModule, Overlay, OverlayRef, _getFocusedElementPierceShadowDom, BasePortalOutlet, CdkPortalOutlet, i3, ComponentPortal, TemplatePortal, PortalModule, DOCUMENT, i0, Component, ViewEncapsulation, ChangeDetectionStrategy, Optional, Inject, ViewChild, InjectionToken, Injector, TemplateRef, Injectable, SkipSelf, NgModule, ESCAPE, hasModifierKey, Subject, defer, of, Directionality, startWith;
    return {
        setters: [function (module) {
            i1 = module;
            A11yModule = module.A11yModule;
        }, function (module) {
            i1$1 = module;
            OverlayConfig = module.OverlayConfig;
            OverlayModule = module.OverlayModule;
            Overlay = module.Overlay;
            OverlayRef = module.OverlayRef;
        }, function (module) {
            _getFocusedElementPierceShadowDom = module._getFocusedElementPierceShadowDom;
        }, function (module) {
            BasePortalOutlet = module.BasePortalOutlet;
            CdkPortalOutlet = module.CdkPortalOutlet;
            i3 = module;
            ComponentPortal = module.ComponentPortal;
        ...
        execute: (function () {
            ...
            const DIALOG_SCROLL_STRATEGY = exports("DIALOG_SCROLL_STRATEGY", new InjectionToken('DialogScrollStrategy'));
            /** Injection token for the Dialog's Data. */
            const DIALOG_DATA = exports("DIALOG_DATA", new InjectionToken('DialogData'));
            /** Injection token that can be used to provide default options for the dialog module. */
            const DEFAULT_DIALOG_CONFIG = exports("DEFAULT_DIALOG_CONFIG", new InjectionToken('DefaultDialogConfig'));
            /** @docs-private */
            function DIALOG_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay) {
              return () => overlay.scrollStrategies.block();
            }
            /** @docs-private */
            const DIALOG_SCROLL_STRATEGY_PROVIDER = exports("DIALOG_SCROLL_STRATEGY_PROVIDER", {
