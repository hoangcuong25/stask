/* esm-bundle - @angular/platform-browser - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', '@angular/common', '@angular/common/http'], (function (exports) {
  'use strict';
  var i0, Injectable, InjectionToken, _RuntimeError, Inject, APP_ID, CSP_NONCE, PLATFORM_ID, Optional, ViewEncapsulation, RendererStyleFlags2, createPlatformFactory, platformCore, _INJECTOR_SCOPE, ErrorHandler, NgZone, RendererFactory2, ApplicationModule, NgModule, SkipSelf, _Console, forwardRef, _XSS_SECURITY_URL, SecurityContext, _allowSanitizationBypassAndThrow, _unwrapSafeValue, __sanitizeUrl, __sanitizeHtml, _bypassSanitizationTrustHtml, _bypassSanitizationTrustStyle, _bypassSanitizationTrustScript, _bypassSanitizationTrustUrl, _bypassSanitizationTrustResourceUrl, Injector, Version, _global, _internalCreateApplication, PLATFORM_INITIALIZER, _TESTABILITY_GETTER, _TESTABILITY, Testability, TestabilityRegistry, __inject, makeEnvironmentProviders, _withDomHydration, makeStateKey$1, TransferState$1, _setDocument, ApplicationRef, ENVIRONMENT_INITIALIZER, inject, _formatRuntimeError, isPlatformServer, DOCUMENT, _getDOM, XhrFactory, CommonModule, _setRootDomAdapter, _parseCookieValue, _PLATFORM_BROWSER_ID, _DomAdapter, _withHttpTransferCache;
  return {
    setters: [function (module) {
      ...
      makeStateKey$1 = module.makeStateKey;
      TransferState$1 = module.TransferState;
    ...
    execute: (function () {
       ...
       * @publicApi
       */
      const EVENT_MANAGER_PLUGINS = exports("EVENT_MANAGER_PLUGINS", new InjectionToken('EventManagerPlugins'));
      /**
       ...
       * @publicApi
       */
      const REMOVE_STYLES_ON_COMPONENT_DESTROY = exports("REMOVE_STYLES_ON_COMPONENT_DESTROY", new InjectionToken('RemoveStylesOnCompDestroy', {
        providedIn: 'root',
  ...
  - There is corresponding configuration for the animation named \`${name}\` defined in the \`animations\` field of the \`@Component\` decorator (see https://angular.io/api/core/Component#animations).`);
      ...
      class KeyEventsPlugin extends EventManagerPlugin {
        ...
        addEventListener(element, eventName, handler) {
          ...
          return this.manager.getZone().runOutsideAngular(() => {
            return _getDOM().onAndCancel(element, parsedEvent['domEventName'], outsideHandler);
          });
        }
        /**
      ...
      const INTERNAL_BROWSER_PLATFORM_PROVIDERS = exports("ɵINTERNAL_BROWSER_PLATFORM_PROVIDERS", [{
        provide: PLATFORM_ID,
      ...
      class BrowserModule {
        constructor(providersAlreadyPresent) {
          if ((typeof ngDevMode === 'undefined' || ngDevMode) && providersAlreadyPresent) {
            throw new _RuntimeError(5100 /* RuntimeErrorCode.BROWER_MODULE_ALREADY_LOADED */, `Providers from the \`BrowserModule\` have already been loaded. If you need access ` + `to common directives such as NgIf and NgFor, import the \`CommonModule\` instead.`);
          }
        }
        /**
       ...
       */
      function createMeta() {
        return new Meta(__inject(DOCUMENT));
      }
      /**
      ...
      function createTitle() {
        return new Title(__inject(DOCUMENT));
      }
      /**
       ...
       * @publicApi
       */
      const HAMMER_GESTURE_CONFIG = exports("HAMMER_GESTURE_CONFIG", new InjectionToken('HammerGestureConfig'));
      /**
       * Injection token used to provide a {@link HammerLoader} to Angular.
       *
       * @publicApi
       */
      const HAMMER_LOADER = exports("HAMMER_LOADER", new InjectionToken('HammerLoader'));
      /**
        ...
        static {
          this.ɵinj = /* @__PURE__ */i0.ɵɵdefineInjector({
            providers: [{
              ...
              multi: true,
              deps: [DOCUMENT, HAMMER_GESTURE_CONFIG, _Console, [new Optional(), HAMMER_LOADER]]
            }, {
      ...
      function provideClientHydration(...features) {
        ...
        return makeEnvironmentProviders([typeof ngDevMode !== 'undefined' && ngDevMode ? provideZoneJsCompatibilityDetector() : [], featuresKind.has(0 /* HydrationFeatureKind.NoDomReuseFeature */) ? [] : _withDomHydration(), featuresKind.has(1 /* HydrationFeatureKind.NoHttpTransferCache */) ? [] : _withHttpTransferCache(), providers]);
      }
      ...
      const makeStateKey = exports("makeStateKey", makeStateKey$1);
      // The below type is needed for G3 due to JSC_CONFORMANCE_VIOLATION.
      const TransferState = exports("TransferState", TransferState$1);
