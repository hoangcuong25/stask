/* esm-bundle - @angular/forms - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', '@angular/common', 'rxjs', 'rxjs/operators'], (function (exports) {
  'use strict';
  var i0, Directive, InjectionToken, forwardRef, Optional, Inject, Self, EventEmitter, Input, Host, SkipSelf, booleanAttribute, ChangeDetectorRef, Output, NgModule, Injectable, inject, _RuntimeError, Version, _isPromise, _isSubscribable, _getDOM, forkJoin, from, map;
  return {
    ...
    execute: (function () {
       ...
       * @publicApi
       */
      const NG_VALUE_ACCESSOR = exports("NG_VALUE_ACCESSOR", new InjectionToken('NgValueAccessor'));
       ...
       * @publicApi
       */
      const COMPOSITION_BUFFER_MODE = exports("COMPOSITION_BUFFER_MODE", new InjectionToken('CompositionEventMode'));
      /**
       ...
       * @publicApi
       */
      const NG_VALIDATORS = exports("NG_VALIDATORS", new InjectionToken('NgValidators'));
      /**
       * @description
       ...
       * @publicApi
       */
      const NG_ASYNC_VALIDATORS = exports("NG_ASYNC_VALIDATORS", new InjectionToken('NgAsyncValidators'));
      /**
