/* esm-bundle - @angular/cdk/text-field - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/cdk/platform', '@angular/core', '@angular/cdk/coercion', 'rxjs', 'rxjs/operators', '@angular/common'], (function (exports) {
    'use strict';
    var normalizePassiveListenerOptions, i1, i0, Injectable, EventEmitter, Directive, Output, Optional, Inject, Input, NgModule, coerceElement, coerceNumberProperty, coerceBooleanProperty, EMPTY, Subject, fromEvent, auditTime, takeUntil, DOCUMENT;
    return {
