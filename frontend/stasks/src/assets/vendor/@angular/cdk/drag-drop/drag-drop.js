/* esm-bundle - @angular/cdk/drag-drop - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', '@angular/common', '@angular/cdk/scrolling', '@angular/cdk/platform', '@angular/cdk/coercion', '@angular/cdk/a11y', 'rxjs', 'rxjs/operators', '@angular/cdk/bidi'], (function (exports) {
    'use strict';
    var i0, Injectable, Inject, InjectionToken, Directive, Optional, SkipSelf, Input, EventEmitter, Self, ContentChildren, ContentChild, Output, NgModule, DOCUMENT, i1, CdkScrollableModule, normalizePassiveListenerOptions, _getEventTarget, _getShadowRoot, coerceBooleanProperty, coerceElement, coerceNumberProperty, coerceArray, isFakeTouchstartFromScreenReader, isFakeMousedownFromScreenReader, Subject, Observable, merge, Subscription, interval, animationFrameScheduler, map, take, takeUntil, startWith, tap, switchMap, i1$1;
    return {
        setters: [function (module) {
            ...
            i1 = module;
            CdkScrollableModule = module.CdkScrollableModule;
        }, function (module) {
            ...
            isFakeTouchstartFromScreenReader = module.isFakeTouchstartFromScreenReader;
            isFakeMousedownFromScreenReader = module.isFakeMousedownFromScreenReader;
        }, function (module) {
        ...
        execute: (function () {
             ...
             * @docs-private
             */
            const CDK_DRAG_PARENT = exports("CDK_DRAG_PARENT", new InjectionToken('CDK_DRAG_PARENT'));
             ...
             */
            const CDK_DRAG_HANDLE = exports("CDK_DRAG_HANDLE", new InjectionToken('CdkDragHandle'));
             ...
             * retention of the class and its directive metadata.
             */
            const CDK_DRAG_PLACEHOLDER = exports("CDK_DRAG_PLACEHOLDER", new InjectionToken('CdkDragPlaceholder'));
            /**
             ...
             * retention of the class and its directive metadata.
             */
            const CDK_DRAG_PREVIEW = exports("CDK_DRAG_PREVIEW", new InjectionToken('CdkDragPreview'));
            /**
             ...
             */
            const CDK_DRAG_CONFIG = exports("CDK_DRAG_CONFIG", new InjectionToken('CDK_DRAG_CONFIG'));
             ...
             * retention of the class and its directive metadata.
             */
            const CDK_DROP_LIST = exports("CDK_DROP_LIST", new InjectionToken('CdkDropList'));
             ...
             * retention of the class and its directive metadata.
             */
            const CDK_DROP_LIST_GROUP = exports("CDK_DROP_LIST_GROUP", new InjectionToken('CdkDropListGroup'));
            /**
