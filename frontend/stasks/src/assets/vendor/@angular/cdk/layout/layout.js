/* esm-bundle - @angular/cdk/layout - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', '@angular/cdk/coercion', 'rxjs', 'rxjs/operators', '@angular/cdk/platform'], (function (exports) {
    'use strict';
    var i0, NgModule, CSP_NONCE, Injectable, Optional, Inject, coerceArray, Subject, combineLatest, concat, Observable, take, skip, debounceTime, map, startWith, takeUntil, i1;
    return {
