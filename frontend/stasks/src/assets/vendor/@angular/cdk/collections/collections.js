/* esm-bundle - @angular/cdk/collections - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['rxjs', '@angular/core'], (function (exports) {
    'use strict';
    var ConnectableObservable, isObservable, of, Subject, i0, Injectable, InjectionToken;
    return {
        ...
        execute: (function () {
            ...
            exports({
                getMultipleValuesInSingleSelectionError: getMultipleValuesInSingleSelectionError,
                isDataSource: isDataSource
            });

            class DataSource {} exports("DataSource", DataSource);
             ...
             * @docs-private
             */
            const _VIEW_REPEATER_STRATEGY = exports("_VIEW_REPEATER_STRATEGY", new InjectionToken('_ViewRepeater'));
