/* esm-bundle - @angular/cdk/a11y - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/common', '@angular/core', '@angular/cdk/platform', 'rxjs', '@angular/cdk/keycodes', 'rxjs/operators', '@angular/cdk/coercion', '@angular/cdk/observers', '@angular/cdk/layout'], (function (exports) {
    'use strict';
    var DOCUMENT, inject, APP_ID, i0, Injectable, Inject, Directive, Input, InjectionToken, Optional, EventEmitter, Output, NgModule, QueryList, i1, _getFocusedElementPierceShadowDom, normalizePassiveListenerOptions, _getEventTarget, _getShadowRoot, BehaviorSubject, Subject, of, Subscription, hasModifierKey, A, Z, ZERO, NINE, PAGE_DOWN, PAGE_UP, END, HOME, LEFT_ARROW, RIGHT_ARROW, UP_ARROW, DOWN_ARROW, TAB, ALT, CONTROL, MAC_META, META, SHIFT, skip, distinctUntilChanged, takeUntil, tap, debounceTime, filter, map, take, coerceBooleanProperty, coerceElement, i1$1, ObserversModule, BreakpointObserver;
    return {
        setters: [function (module) {
            ...
            normalizePassiveListenerOptions = module.normalizePassiveListenerOptions;
            _getEventTarget = module._getEventTarget;
            _getShadowRoot = module._getShadowRoot;
        }, function (module) {
            ...
            ZERO = module.ZERO;
            NINE = module.NINE;
            PAGE_DOWN = module.PAGE_DOWN;
            PAGE_UP = module.PAGE_UP;
            END = module.END;
            HOME = module.HOME;
            ...
            i1$1 = module;
            ObserversModule = module.ObserversModule;
        }, function (module) {
            BreakpointObserver = module.BreakpointObserver;
        }],
        execute: (function () {

            exports({
                LIVE_ANNOUNCER_ELEMENT_TOKEN_FACTORY: LIVE_ANNOUNCER_ELEMENT_TOKEN_FACTORY,
                addAriaReferencedId: addAriaReferencedId,
                getAriaReferenceIds: getAriaReferenceIds,
                isFakeMousedownFromScreenReader: isFakeMousedownFromScreenReader,
                isFakeTouchstartFromScreenReader: isFakeTouchstartFromScreenReader,
                removeAriaReferencedId: removeAriaReferencedId
            });
             ...
             */
            const MESSAGES_CONTAINER_ID = exports("MESSAGES_CONTAINER_ID", 'cdk-describedby-message-container');
            /**
             * ID prefix used for each created message element.
             * @deprecated To be turned into a private variable.
             * @breaking-change 14.0.0
             */
            const CDK_DESCRIBEDBY_ID_PREFIX = exports("CDK_DESCRIBEDBY_ID_PREFIX", 'cdk-describedby-message');
            /**
             * Attribute given to each host element that is described by a message element.
             * @deprecated To be turned into a private variable.
             * @breaking-change 14.0.0
             */
            const CDK_DESCRIBEDBY_HOST_ATTRIBUTE = exports("CDK_DESCRIBEDBY_HOST_ATTRIBUTE", 'cdk-describedby-host');
            ...
            const FOCUS_TRAP_INERT_STRATEGY = exports("FOCUS_TRAP_INERT_STRATEGY", new InjectionToken('FOCUS_TRAP_INERT_STRATEGY'));
             ...
             * options.
             */
            const INPUT_MODALITY_DETECTOR_OPTIONS = exports("INPUT_MODALITY_DETECTOR_OPTIONS", new InjectionToken('cdk-input-modality-detector-options'));
            /**
             ...
             */
            const INPUT_MODALITY_DETECTOR_DEFAULT_OPTIONS = exports("INPUT_MODALITY_DETECTOR_DEFAULT_OPTIONS", {
            ...
            const LIVE_ANNOUNCER_ELEMENT_TOKEN = exports("LIVE_ANNOUNCER_ELEMENT_TOKEN", new InjectionToken('liveAnnouncerElement', {
              providedIn: 'root',
            ...
            const LIVE_ANNOUNCER_DEFAULT_OPTIONS = exports("LIVE_ANNOUNCER_DEFAULT_OPTIONS", new InjectionToken('LIVE_ANNOUNCER_DEFAULT_OPTIONS'));
            let uniqueIds = 0;
            class LiveAnnouncer {
            ...
            const FOCUS_MONITOR_DEFAULT_OPTIONS = exports("FOCUS_MONITOR_DEFAULT_OPTIONS", new InjectionToken('cdk-focus-monitor-default-options'));
            /**
