/* esm-bundle - @angular/cdk/table - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/cdk/bidi', '@angular/cdk/coercion', '@angular/cdk/collections', '@angular/cdk/platform', '@angular/cdk/scrolling', '@angular/common', '@angular/core', 'rxjs', 'rxjs/operators'], (function (exports) {
  'use strict';
  var i1, coerceBooleanProperty, _VIEW_REPEATER_STRATEGY, _RecycleViewRepeaterStrategy, isDataSource, _DisposeViewRepeaterStrategy, i2, i3, ScrollingModule, DOCUMENT, InjectionToken, i0, Directive, Inject, Optional, Input, ContentChild, Injectable, Component, ChangeDetectionStrategy, ViewEncapsulation, EventEmitter, NgZone, Attribute, SkipSelf, Output, ViewChild, ContentChildren, NgModule, Subject, from, BehaviorSubject, isObservable, of, takeUntil, take;
  return {
    setters: [function (module) {
      ...
      _DisposeViewRepeaterStrategy = module._DisposeViewRepeaterStrategy;
      exports("DataSource", module.DataSource);
    }, function (module) {
      i2 = module;
    }, function (module) {
      i3 = module;
    ...
    execute: (function () {
       ...
       * @docs-private
       */
      const CDK_TABLE = exports("CDK_TABLE", new InjectionToken('CDK_TABLE'));
      /** Injection token that can be used to specify the text column options. */
      const TEXT_COLUMN_OPTIONS = exports("TEXT_COLUMN_OPTIONS", new InjectionToken('text-column-options'));
      ...
      const _COALESCED_STYLE_SCHEDULER = exports("_COALESCED_STYLE_SCHEDULER", new InjectionToken('_COALESCED_STYLE_SCHEDULER'));
      /**
       ...
       * material library.
       */
      const CDK_ROW_TEMPLATE = exports("CDK_ROW_TEMPLATE", `<ng-container cdkCellOutlet></ng-container>`);
      /**
       ...
       * @docs-private
       */
      const STICKY_DIRECTIONS = exports("STICKY_DIRECTIONS", ['top', 'bottom', 'left', 'right']);
      /**
      ...
      const STICKY_POSITIONING_LISTENER = exports("STICKY_POSITIONING_LISTENER", new InjectionToken('CDK_SPL'));
      ...
      exports("CDK_TABLE_TEMPLATE", // Note that according to MDN, the `caption` element has to be projected as the **first**
