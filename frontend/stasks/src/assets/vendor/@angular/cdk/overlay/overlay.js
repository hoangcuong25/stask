/* esm-bundle - @angular/cdk/overlay - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/cdk/scrolling', '@angular/common', '@angular/core', '@angular/cdk/coercion', '@angular/cdk/platform', 'rxjs/operators', '@angular/cdk/bidi', '@angular/cdk/portal', 'rxjs', '@angular/cdk/keycodes'], (function (exports) {
    'use strict';
    var i1, ScrollingModule, DOCUMENT, i6, i0, Injectable, Inject, Optional, ApplicationRef, ANIMATION_MODULE_TYPE, InjectionToken, Directive, EventEmitter, Input, Output, NgModule, ElementRef, coerceBooleanProperty, coerceCssPixelValue, coerceArray, supportsScrollBehavior, _getEventTarget, i1$1, _isTestEnvironment, takeWhile, filter, take, takeUntil, i5, BidiModule, DomPortalOutlet, TemplatePortal, PortalModule, Subscription, Subject, merge, ESCAPE, hasModifierKey;
    return {
        setters: [function (module) {
            i1 = module;
            ScrollingModule = module.ScrollingModule;
            exports({ CdkScrollable: module.CdkScrollable, ScrollDispatcher: module.ScrollDispatcher, ViewportRuler: module.ViewportRuler });
        }, function (module) {
            ...
            DomPortalOutlet = module.DomPortalOutlet;
        ...
        execute: (function () {
            ...
            exports({
                validateHorizontalPosition: validateHorizontalPosition,
                validateVerticalPosition: validateVerticalPosition
            });
             ...
             *  @docs-private
             */
            class ScrollingVisibility {} exports("ScrollingVisibility", ScrollingVisibility);
            ...
            const STANDARD_DROPDOWN_BELOW_POSITIONS = exports("STANDARD_DROPDOWN_BELOW_POSITIONS", [{
              originX: 'start',
              originY: 'bottom',
              overlayX: 'start',
              overlayY: 'top'
            ...
            const STANDARD_DROPDOWN_ADJACENT_POSITIONS = exports("STANDARD_DROPDOWN_ADJACENT_POSITIONS", [{
              originX: 'end',
              originY: 'top',
              overlayX: 'start',
              overlayY: 'top'
