/* esm-bundle - @angular/common/http - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', 'rxjs', 'rxjs/operators', '@angular/common'], (function (exports) {
    'use strict';
    var i0, Injectable, inject, NgZone, InjectionToken, _InitialRenderPendingTasks, Inject, _RuntimeError, PLATFORM_ID, NgModule, makeEnvironmentProviders, _ENABLED_SSR_FEATURES, TransferState, APP_BOOTSTRAP_LISTENER, ApplicationRef, makeStateKey, of, Observable, from, concatMap, filter, map, finalize, switchMap, first, tap, DOCUMENT, i1, _parseCookieValue;
    return {
        setters: [function (module) {
            ...
            _ENABLED_SSR_FEATURES = module.ɵENABLED_SSR_FEATURES;
        ...
        execute: (function () {
            ...
            function legacyInterceptorFnFactory() {
              ...
              return (req, handler) => {
                ...
                const pendingTasks = inject(_InitialRenderPendingTasks);
            ...
            function withHttpTransferCache() {
              return [{
                provide: CACHE_STATE,
                useFactory: () => {
                  inject(_ENABLED_SSR_FEATURES).add('httpcache');
                  return {
                    isCacheActive: true
                  };
                }
