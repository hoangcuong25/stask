/* esm-bundle - @angular/common - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core'], (function (exports) {
  'use strict';
  var InjectionToken, i0, inject, Injectable, Optional, Inject, EventEmitter, __inject, LOCALE_ID, _stringify, Directive, Input, createNgModule, NgModuleRef, _RuntimeError, Host, Attribute, RendererStyleFlags2, _isPromise, _isSubscribable, Pipe, DEFAULT_CURRENCY_CODE, NgModule, Version, __defineInjectable, _formatRuntimeError, Renderer2, ElementRef, Injector, PLATFORM_ID, NgZone, numberAttribute, booleanAttribute, _unwrapSafeValue, _findLocaleData, _LocaleDataIndex, _getLocaleCurrencyCode, _getLocalePluralCase, _registerLocaleData, untracked;
  return {
    ...
    execute: (function () {
       ...
       * @publicApi
       */
      const DOCUMENT = exports("DOCUMENT", new InjectionToken('DocumentToken'));
       ...
       * @publicApi
       */
      const LOCATION_INITIALIZED = exports("LOCATION_INITIALIZED", new InjectionToken('Location Initialized'));
      /**
       ...
       * @publicApi
       */
      const APP_BASE_HREF = exports("APP_BASE_HREF", new InjectionToken('appBaseHref'));
      /**
       * @description
       ...
       * @publicApi
       */
      var NumberSymbol; exports("NumberSymbol", NumberSymbol);
      ...
      function assertTemplate(property, templateRef) {
        ...
        if (!isTemplateRefOrNull) {
          throw new Error(`${property} must be a TemplateRef, but received '${_stringify(templateRef)}'.`);
        }
      }
      class SwitchView {
       ...
       */
      const DATE_PIPE_DEFAULT_TIMEZONE = exports("DATE_PIPE_DEFAULT_TIMEZONE", new InjectionToken('DATE_PIPE_DEFAULT_TIMEZONE'));
      /**
       ...
       * ```
       */
      const DATE_PIPE_DEFAULT_OPTIONS = exports("DATE_PIPE_DEFAULT_OPTIONS", new InjectionToken('DATE_PIPE_DEFAULT_OPTIONS'));
      // clang-format off
      /**
       * @ngModule CommonModule
       * @description
      ...
      const PLATFORM_WORKER_APP_ID = exports("ɵPLATFORM_WORKER_APP_ID", 'browserWorkerApp');
      const PLATFORM_WORKER_UI_ID = exports("ɵPLATFORM_WORKER_UI_ID", 'browserWorkerUi');
      /**
      ...
      class ViewportScroller {
        ...
        /** @nocollapse */
        static {
          this.ɵprov = __defineInjectable({
            token: ViewportScroller,
            providedIn: 'root',
            factory: () => new BrowserViewportScroller(__inject(DOCUMENT), window)
          });
        }
       ...
       * @publicApi
       */
      const IMAGE_LOADER = exports("IMAGE_LOADER", new InjectionToken('ImageLoader', {
        providedIn: 'root',
      ...
      function logMissingPriorityWarning(ngSrc) {
        ...
        console.warn(_formatRuntimeError(2955 /* RuntimeErrorCode.LCP_IMG_MISSING_PRIORITY */, `${directiveDetails} this image is the Largest Contentful Paint (LCP) ` + `element but was not marked "priority". This image should be marked ` + `"priority" in order to prioritize its loading. ` + `To fix this, add the "priority" attribute.`));
      }
       ...
       * @publicApi
       */
      const PRECONNECT_CHECK_BLOCKLIST = exports("PRECONNECT_CHECK_BLOCKLIST", new InjectionToken('PRECONNECT_CHECK_BLOCKLIST'));
      /**
       ...
       * @publicApi
       */
      const IMAGE_CONFIG = exports("IMAGE_CONFIG", new InjectionToken('ImageConfig', {
        providedIn: 'root',
      ...
      function postInitInputChangeError(dir, inputName) {
        ...
        return new _RuntimeError(2953 /* RuntimeErrorCode.UNEXPECTED_INPUT_CHANGE */, `${imgDirectiveDetails(dir.ngSrc)} \`${inputName}\` was updated after initialization. ` + `The NgOptimizedImage directive will not react to this input change. ${reason} ` + `To fix this, either switch \`${inputName}\` to a static value ` + `or wrap the image element in an *ngIf that is gated on the necessary value.`);
      }
      /**
