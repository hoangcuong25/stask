/* esm-bundle - @angular/animations/browser - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/animations', '@angular/core'], (function (exports) {
    'use strict';
    var NoopAnimationPlayer, style, AUTO_STYLE, _PRE_STYLE, _AnimationGroupPlayer, sequence, i0, Injectable, _RuntimeError;
    return {
        setters: [function (module) {
            NoopAnimationPlayer = module.NoopAnimationPlayer;
            style = module.style;
            AUTO_STYLE = module.AUTO_STYLE;
            _PRE_STYLE = module.ɵPRE_STYLE;
            _AnimationGroupPlayer = module.ɵAnimationGroupPlayer;
