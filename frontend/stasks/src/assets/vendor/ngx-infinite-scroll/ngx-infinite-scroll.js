/* esm-bundle - ngx-infinite-scroll - Ivy - system format - Use of this source code is governed by an MIT-style license that can be found in the LICENSE file at https://angular.io/license */
System.register(['@angular/core', 'rxjs', 'rxjs/operators'], (function (exports) {
    'use strict';
    var i0, Injectable, EventEmitter, Directive, Output, Input, NgModule, of, fromEvent, mergeMap, map, tap, filter, throttleTime;
    return {
        setters: [function (module) {
            ...
            throttleTime = module.throttleTime;
        }],
        execute: (function () {
            ...
            } exports("NgxInfiniteScrollService", NgxInfiniteScrollService);
            (function () {
